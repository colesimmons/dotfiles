...
# Overwrite /etc/hosts with ad-blocking hosts file in ./configs/hosts
...
if [[ $? = 0 ]]; then
  githubuser="colesimmons"
  firstname="Cole"
  lastname="Simmons"
  fullname="Cole Simmons"
  email="colesimmons223@gmail.com"
...
running "Set highlight color to purple-ish"
defaults write NSGlobalDomain AppleHighlightColor -string "0.470 0.0392 1";ok
...
running "Set alert volume to 0"
defaults write .GlobalPreferences com.apple.sound.beep.volume -int 0;ok
defaults write .GlobalPreferences com.apple.sound.uiaudio.enabled -int 0;ok
...
running "Set Touch Bar to Expanded Control Strip"
